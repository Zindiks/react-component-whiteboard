...
// node_modules/electron-reloader/node_modules/electron-is-dev/index.js
var require_electron_is_dev = __commonJS({
  "node_modules/electron-reloader/node_modules/electron-is-dev/index.js"(exports, module2) {
    "use strict";
    var electron2 = __require("electron");
    if (typeof electron2 === "string") {
      throw new TypeError("Not running in an Electron environment!");
    }
    var app2 = electron2.app || electron2.remote.app;
    var isEnvSet2 = "ELECTRON_IS_DEV" in process.env;
    var getFromEnv2 = parseInt(process.env.ELECTRON_IS_DEV, 10) === 1;
    module2.exports = isEnvSet2 ? getFromEnv2 : !app2.isPackaged;
  }
});
...
var require_electron_reloader = __commonJS({
  "node_modules/electron-reloader/index.js"(exports, module2) {
    "use strict";
    var { inspect } = __require("util");
    var path2 = __require("path");
    var electron2 = __require("electron");
    var chokidar = require_chokidar();
    var isDev2 = require_electron_is_dev();
    var dateTime = require_date_time();
    var chalk = require_source();
    var findUp = require_find_up();
    function getMainProcessPaths(topModuleObject, cwd) {
      const paths = /* @__PURE__ */ new Set([topModuleObject.filename]);
      const getPaths = (moduleObject) => {
        for (const child of moduleObject.children) {
          if (paths.has(child.filename)) {
            continue;
          }
          if (path2.relative(cwd, child.filename).includes("node_modules")) {
            continue;
          }
    ...
    module2.exports = (moduleObject, options = {}) => {
      if (!isDev2) {
        return;
      }
      if (!moduleObject) {
      ...
      const mainProcessDirectory = path2.dirname(moduleObject.filename);
      const packageDirectory = findUp.sync("package.json", { cwd: mainProcessDirectory });
      const cwd = packageDirectory ? path2.dirname(packageDirectory) : mainProcessDirectory;
      ...
      watcher.on("change", (filePath) => {
        ...
        if (mainProcessPaths.has(path2.join(cwd, filePath))) {
          if (!isRelaunching) {
            electron2.app.relaunch();
            electron2.app.exit(0);
          }
          isRelaunching = true;
        } else {
          for (const window_ of electron2.BrowserWindow.getAllWindows()) {
...
var electron_is_dev_exports = {};
__export(electron_is_dev_exports, {
  default: () => electron_is_dev_default
});
...
// electron/main.ts
if (electron_is_dev_exports) {
  Promise.resolve().then(() => __toESM(require_electron_reloader(), 1)).then((reloader) => {
...
var createWindow = () => {
  ...
  const startUrl = electron_is_dev_exports ? "http://localhost:5173" : `file://${path.join(__dirname, "../dist/index.html")}`;
